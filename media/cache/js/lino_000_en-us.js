...
// lino.js --- generated Sun Jan  4 15:44:48 2015 by Lino version 1.6.16.
...
Lino.main_menu = [ { "menu": { "items": [ { "text": "products", "handler": function() {Lino.lets.Products.grid.run(null)} }, { "text": "customers", "handler": function() {Lino.lets.Customers.grid.run(null)} }, { "text": "providers", "handler": function() {Lino.lets.Providers.grid.run(null)} } ] }, "text": "Master" }, { "menu": { "items": [ { "text": "offers", "handler": function() {Lino.lets.Offers.grid.run(null)} }, { "text": "demands", "handler": function() {Lino.lets.Demands.grid.run(null)} } ] }, "text": "Market" }, { "menu": { "items": [ { "text": "places", "handler": function() {Lino.lets.Places.grid.run(null)} } ] }, "text": "Configure" }, { "text": "Home", "handler": function() {Lino.handle_home_button()} } ];
...
Lino.about.Inspector.ParamsPanel = Ext.extend(Ext.form.FormPanel,{
  ...
  autoHeight: true,
  initComponent : function() {
    var inspected61 = new Ext.form.TextField({ "autoHeight": true, "fieldLabel": "Inspected object", "name": "inspected", "maxLength": 100, "selectOnFocus": true, "anchor": "-20" });
    var show_callables62 = new Ext.form.Checkbox({ "boxLabel": "show callables", "autoHeight": true, "hideLabel": true, "checked": false, "name": "show_callables", "selectOnFocus": true, "anchor": "-20" });
    this.items = [ { "flex": 67, "autoHeight": true, "layout": "form", "xtype": "panel", "items": inspected61, "labelAlign": "top" }, { "flex": 32, "autoHeight": true, "layout": "form", "xtype": "panel", "items": show_callables62, "labelAlign": "top" } ];
    this.fields = [ inspected61, show_callables62 ];
...
Lino.lets.Providers.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var place3 = new Lino.RemoteComboFieldElement({ "autoHeight": true, "fieldLabel": "place", "name": "place", "pageSize": 20, "emptyText": "Select a place...", "selectOnFocus": true, "hiddenName": "placeHidden", "anchor": "-20", "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Providers/place", "method": "GET" }) }) });
    var email4 = new Ext.form.TextField({ "autoHeight": true, "fieldLabel": "email", "name": "email", "maxLength": 200, "selectOnFocus": true, "anchor": "-20" });
    var main_1_panel5 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 54, "hideCheckBoxLabels": true, "items": [ { "flex": 7, "autoHeight": true, "layout": "form", "xtype": "panel", "items": id1, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name2, "labelAlign": "top" }, { "flex": 29, "autoHeight": true, "layout": "form", "xtype": "panel", "items": place3, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": email4, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var OffersByProvider_grid14 = new Lino.lets.OffersByProvider.GridPanel({ "flex": 83, "hide_top_toolbar": true, "containing_panel": this, "tools": [ Lino.show_in_own_window_button(Lino.lets.OffersByProvider.grid) ], "preview_limit": 15, "master_panel": this });
    var main_panel15 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel5, OffersByProvider_grid14 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel15;
    this.before_row_edit = function(record) {
      OffersByProvider_grid14.on_master_changed();
    }
...
Lino.about.About.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var server_status_disp67 = new Ext.form.DisplayField({ "disabled": true, "autoHeight": true, "fieldLabel": "Server status", "name": "server_status", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var main_panel68 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "labelWidth": 126, "hideCheckBoxLabels": true, "items": [ { "flex": 25, "html": "<div class=\"htmlText\"><span>This is <b>yet another Lino site</b> using <a href=\"http://www.lino-framework.org\" target=\"_blank\">Lino</a> 1.6.16, <a href=\"http://www.djangoproject.com\" target=\"_blank\">Django</a> 1.6.9, <a href=\"http://www.python.org/\" target=\"_blank\">Python</a> 2.7.5, <a href=\"http://babel.edgewall.org/\" target=\"_blank\">Babel</a> 1.3, <a href=\"http://jinja.pocoo.org/\" target=\"_blank\">Jinja</a> 2.7.3, <a href=\"http://sphinx-doc.org/\" target=\"_blank\">Sphinx</a> 1.3b2, <a href=\"http://labix.org/python-dateutil\" target=\"_blank\">python-dateutil</a> 2.3, <a href=\"http://pypi.python.org/pypi/odfpy\" target=\"_blank\">OdfPy</a> ODFPY/0.9.6, <a href=\"http://docutils.sourceforge.net/\" target=\"_blank\">docutils</a> 0.12, <a href=\"https://fedorahosted.org/suds/\" target=\"_blank\">suds</a> (not installed), <a href=\"http://pyyaml.org/\" target=\"_blank\">PyYaml</a> 3.11, <a href=\"http://appyframework.org/pod.html\" target=\"_blank\">Appy</a> 0.9.1 (2014/11/12 09:06), <a href=\"http://www.sencha.com\" target=\"_blank\">ExtJS</a> <a href=\"#\" onclick=\"alert('ExtJS client version is ' + Ext.version);\" title=\"Click to see ExtJS client version\">(version)</a>, <a href=\"http://www.famfamfam.com/lab/icons/silk/\" target=\"_blank\">Silk Icons</a> 1.3, <a href=\"http://getbootstrap.com\" target=\"_blank\">Bootstrap</a> 3.x</span><p>Server uptime : <b>Sunday, January 4, 2015 at 15:44:32.928155</b></p><p>Source timestamps:</p><ul><li>django : <b>Sunday, January 4, 2015 at 15:05:19.814982</b></li><li>lino : <b>Sunday, January 4, 2015 at 15:04:45</b></li><li>atelier : <b>Monday, December 29, 2014 at 10:34:07</b></li></ul></div>", "xtype": "label" }, { "items": server_status_disp67, "autoHeight": true, "layout": "form", "xtype": "panel", "labelAlign": "top" } ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel68;
    this.before_row_edit = function(record) {
    }
...
Lino.about.Models.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  disable_editing: true,
  initComponent : function() {
    var app_disp46 = new Ext.form.DisplayField({ "disabled": true, "autoHeight": true, "fieldLabel": "app_label", "name": "app", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var name_disp47 = new Ext.form.DisplayField({ "disabled": true, "autoHeight": true, "fieldLabel": "name", "name": "name", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var docstring_disp48 = new Ext.form.DisplayField({ "disabled": true, "autoHeight": true, "fieldLabel": "docstring", "name": "docstring", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var rows49 = new Ext.form.NumberField({ "disabled": true, "autoHeight": true, "fieldLabel": "Rows", "anchor": "-20", "name": "rows" });
    var main_1_panel50 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 90, "hideCheckBoxLabels": true, "items": [ { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": app_disp46, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name_disp47, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": docstring_disp48, "labelAlign": "top" }, { "flex": 5, "autoHeight": true, "layout": "form", "xtype": "panel", "items": rows49, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var about_FieldsByModel_grid59 = new Lino.about.FieldsByModel.GridPanel({ "flex": 62, "hide_top_toolbar": true, "containing_panel": this, "tools": [ Lino.show_in_own_window_button(Lino.about.FieldsByModel.grid) ], "preview_limit": 15, "master_panel": this });
    var main_panel60 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel50, about_FieldsByModel_grid59 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel60;
    this.before_row_edit = function(record) {
      about_FieldsByModel_grid59.on_master_changed();
    }
...
Lino.lets.Customers.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  auto_save: true,
  initComponent : function() {
    var id16 = new Ext.form.NumberField({ "selectOnFocus": true, "autoHeight": true, "fieldLabel": "ID", "anchor": "-20", "name": "id" });
    var name17 = new Ext.form.TextField({ "autoHeight": true, "fieldLabel": "name", "name": "name", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var place18 = new Lino.RemoteComboFieldElement({ "autoHeight": true, "fieldLabel": "place", "name": "place", "pageSize": 20, "emptyText": "Select a place...", "selectOnFocus": true, "hiddenName": "placeHidden", "anchor": "-20", "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Customers/place", "method": "GET" }) }) });
    var email19 = new Ext.form.TextField({ "autoHeight": true, "fieldLabel": "email", "name": "email", "maxLength": 200, "selectOnFocus": true, "anchor": "-20" });
    var main_1_panel20 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 54, "hideCheckBoxLabels": true, "items": [ { "flex": 7, "autoHeight": true, "layout": "form", "xtype": "panel", "items": id16, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name17, "labelAlign": "top" }, { "flex": 29, "autoHeight": true, "layout": "form", "xtype": "panel", "items": place18, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": email19, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var DemandsByCustomer_grid28 = new Lino.lets.DemandsByCustomer.GridPanel({ "flex": 83, "hide_top_toolbar": true, "containing_panel": this, "tools": [ Lino.show_in_own_window_button(Lino.lets.DemandsByCustomer.grid) ], "preview_limit": 15, "master_panel": this });
    var main_panel29 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel20, DemandsByCustomer_grid28 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel29;
    this.before_row_edit = function(record) {
      DemandsByCustomer_grid28.on_master_changed();
    }
...
Lino.lets.Products.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  auto_save: true,
  initComponent : function() {
    var id30 = new Ext.form.NumberField({ "selectOnFocus": true, "autoHeight": true, "fieldLabel": "ID", "anchor": "-20", "name": "id" });
    var name31 = new Ext.form.TextField({ "autoHeight": true, "fieldLabel": "name", "name": "name", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var main_1_panel32 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 45, "hideCheckBoxLabels": true, "items": [ { "flex": 19, "autoHeight": true, "layout": "form", "xtype": "panel", "items": id30, "labelAlign": "top" }, { "flex": 80, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name31, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var OffersByProduct_grid39 = new Lino.lets.OffersByProduct.GridPanel({ "flex": 60, "hide_top_toolbar": true, "containing_panel": this, "tools": [ Lino.show_in_own_window_button(Lino.lets.OffersByProduct.grid) ], "preview_limit": 15, "master_panel": this });
    var DemandsByProduct_grid43 = new Lino.lets.DemandsByProduct.GridPanel({ "flex": 39, "hide_top_toolbar": true, "containing_panel": this, "tools": [ Lino.show_in_own_window_button(Lino.lets.DemandsByProduct.grid) ], "preview_limit": 15, "master_panel": this });
    var main_2_panel44 = new Ext.Panel({ "flex": 83, "border": false, "layout": "hbox", "hideCheckBoxLabels": true, "items": [ OffersByProduct_grid39, DemandsByProduct_grid43 ], "autoScroll": false, "layoutConfig": { "align": "stretch" }, "frame": false, "labelAlign": "top" });
    var main_panel45 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel32, main_2_panel44 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel45;
    this.before_row_edit = function(record) {
      OffersByProduct_grid39.on_master_changed();
      DemandsByProduct_grid43.on_master_changed();
    }
...
Lino.lets.Places.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var name71 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id70, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "width": Lino.chars2width(22), "editable": true, "filter": { "type": "string" }, "header": "name", "editor": name71, "dataIndex": "name" } ];
...
Lino.lets.Providers.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  ls_store_fields : [ { "type": "int", "name": "id" }, { "name": "name" }, { "name": "place" }, 'placeHidden', { "name": "email" }, { "name": "disabled_fields" }, { "name": "disabled_actions" }, { "name": "disable_editing" } ],
  pk_index : 0,
  ls_grid_configs : [  ],
  ls_id_property : "id",
  page_length : 20,
  initComponent : function() {
    ...
    var name74 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var place75 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Providers/place", "method": "GET" }) }), "pageSize": 20, "emptyText": "Select a place..." });
    var email76 = new Ext.form.TextField({ "selectOnFocus": true, "maxLength": 200 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id73, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "width": Lino.chars2width(22), "editable": true, "filter": { "type": "string" }, "header": "name", "editor": name74, "dataIndex": "name" }, { "colIndex": 2, "sortable": true, "width": Lino.chars2width(21), "editable": true, "filter": { "type": "string" }, "header": "place", "editor": place75, "dataIndex": "place" }, { "colIndex": 3, "sortable": true, "width": Lino.chars2width(22), "editable": true, "filter": { "type": "string" }, "header": "email", "editor": email76, "dataIndex": "email" } ];
...
Lino.lets.Customers.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var id78 = new Ext.form.NumberField({ "selectOnFocus": true });
    var name79 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var place80 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Customers/place", "method": "GET" }) }), "pageSize": 20, "emptyText": "Select a place..." });
    var email81 = new Ext.form.TextField({ "selectOnFocus": true, "maxLength": 200 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id78, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "width": Lino.chars2width(22), "editable": true, "filter": { "type": "string" }, "header": "name", "editor": name79, "dataIndex": "name" }, { "colIndex": 2, "sortable": true, "width": Lino.chars2width(21), "editable": true, "filter": { "type": "string" }, "header": "place", "editor": place80, "dataIndex": "place" }, { "colIndex": 3, "sortable": true, "width": Lino.chars2width(22), "editable": true, "filter": { "type": "string" }, "header": "email", "editor": email81, "dataIndex": "email" } ];
...
Lino.lets.Products.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id83, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "width": Lino.chars2width(22), "editable": true, "filter": { "type": "string" }, "header": "name", "editor": name84, "dataIndex": "name" } ];
...
Lino.lets.Offers.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var id86 = new Ext.form.NumberField({ "selectOnFocus": true });
    var provider87 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Offers/provider", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a provider..." });
    var product88 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Offers/product", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a product..." });
    var valid_until89 = new Lino.DateField({ "selectOnFocus": true });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id86, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "provider", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('providerHidden','Lino.lets.Providers.detail'), "dataIndex": "provider", "editor": provider87 }, { "colIndex": 2, "sortable": true, "header": "product", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('productHidden','Lino.lets.Products.detail'), "dataIndex": "product", "editor": product88 }, { "colIndex": 3, "sortable": true, "xtype": "datecolumn", "format": "d.m.Y", "editable": true, "filter": { "type": "date", "dateFormat": "d.m.Y" }, "header": "valid until", "editor": valid_until89, "width": Lino.chars2width(14), "dataIndex": "valid_until" } ];
...
Lino.lets.Demands.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  stripeRows : true,
  disabled_actions_index : 6,
  ls_store_fields : [ { "type": "int", "name": "id" }, { "name": "customer" }, 'customerHidden', { "name": "product" }, 'productHidden', { "name": "disabled_fields" }, { "name": "disabled_actions" }, { "name": "disable_editing" } ],
  pk_index : 0,
  ls_grid_configs : [  ],
  ls_id_property : "id",
  page_length : 20,
  initComponent : function() {
    var ww = this.containing_window;
    var id91 = new Ext.form.NumberField({ "selectOnFocus": true });
    var customer92 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Demands/customer", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a customer..." });
    var product93 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/Demands/product", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a product..." });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id91, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "customer", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('customerHidden','Lino.lets.Customers.detail'), "dataIndex": "customer", "editor": customer92 }, { "colIndex": 2, "sortable": true, "header": "product", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('productHidden','Lino.lets.Products.detail'), "dataIndex": "product", "editor": product93 } ];
...
Lino.lets.OffersByProvider.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var id10 = new Ext.form.NumberField({ "selectOnFocus": true });
    var product11 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/OffersByProvider/product", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a product..." });
    var valid_until12 = new Lino.DateField({ "selectOnFocus": true });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id10, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "product", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('productHidden','Lino.lets.Products.detail'), "dataIndex": "product", "editor": product11 }, { "colIndex": 2, "sortable": true, "xtype": "datecolumn", "format": "d.m.Y", "editable": true, "filter": { "type": "date", "dateFormat": "d.m.Y" }, "header": "valid until", "editor": valid_until12, "width": Lino.chars2width(14), "dataIndex": "valid_until" } ];
...
Lino.lets.OffersByProduct.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var id35 = new Ext.form.NumberField({ "selectOnFocus": true });
    var provider36 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/OffersByProduct/provider", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a provider..." });
    var valid_until37 = new Lino.DateField({ "selectOnFocus": true });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id35, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "provider", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('providerHidden','Lino.lets.Providers.detail'), "dataIndex": "provider", "editor": provider36 }, { "colIndex": 2, "sortable": true, "xtype": "datecolumn", "format": "d.m.Y", "editable": true, "filter": { "type": "date", "dateFormat": "d.m.Y" }, "header": "valid until", "editor": valid_until37, "width": Lino.chars2width(14), "dataIndex": "valid_until" } ];
...
Lino.lets.DemandsByCustomer.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  ls_store_fields : [ { "type": "int", "name": "id" }, { "name": "product" }, 'productHidden', { "name": "disabled_fields" }, { "name": "disabled_actions" }, { "name": "disable_editing" } ],
  pk_index : 0,
  ls_grid_configs : [  ],
  ls_id_property : "id",
  page_length : 20,
  initComponent : function() {
    var ww = this.containing_window;
    var id25 = new Ext.form.NumberField({ "selectOnFocus": true });
    var product26 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/DemandsByCustomer/product", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a product..." });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id25, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "product", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('productHidden','Lino.lets.Products.detail'), "dataIndex": "product", "editor": product26 } ];
...
Lino.lets.DemandsByProduct.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  stripeRows : true,
  disabled_actions_index : 4,
  ls_store_fields : [ { "type": "int", "name": "id" }, { "name": "customer" }, 'customerHidden', { "name": "disabled_fields" }, { "name": "disabled_actions" }, { "name": "disable_editing" } ],
  pk_index : 0,
  ls_grid_configs : [  ],
  ls_id_property : "id",
  page_length : 20,
  initComponent : function() {
    var ww = this.containing_window;
    var id40 = new Ext.form.NumberField({ "selectOnFocus": true });
    var customer41 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/lets/DemandsByProduct/customer", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a customer..." });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "editor": id40, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "customer", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "renderer": Lino.fk_renderer('customerHidden','Lino.lets.Customers.detail'), "dataIndex": "customer", "editor": customer41 } ];
...
Lino.about.Models.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var app_disp95 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var name_disp96 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var docstring_disp97 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var rows98 = new Ext.form.NumberField({ "disabled": true });
    var detail_action_disp99 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.FieldsByModel.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var name_disp55 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var verbose_name_disp56 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var help_text_column_disp57 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.Inspector.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var i_name_disp101 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var i_type_disp102 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var i_value_disp103 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.DetailLayouts.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var datasource_disp105 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var viewable_for_disp106 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var fields_disp107 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.SourceFiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var module_name109 = new Ext.form.TextField({ "disabled": true, "maxLength": null });
    var code_lines110 = new Ext.form.NumberField({ "disabled": true });
    var doc_lines111 = new Ext.form.NumberField({ "disabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.BuildMethods.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value113 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name114 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text115 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    var remark_disp116 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var workflow_buttons_disp117 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
